...
async def simulate_document_processing(job_id: str, document_id: str, file_path: str):
    ...
    try:
        ...
        processing_jobs[job_id]["message"] = "Document parsed, starting content analysis..."
        
        # Step 2: Analyze content
        analysis_result = await content_analyzer.analyze_content(normalized_document)
        processing_jobs[job_id]["progress"] = 50
        processing_jobs[job_id]["message"] = "Content analyzed, generating study guide..."
        ...
        processing_jobs[job_id]["message"] = "Study guide generated, finalizing..."
        ...
        try:
            ...
            db_study_guide = StudyGuide(
                ...
                detailed_content="",  # Will store as JSON
                detail_level="standard",
